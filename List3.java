...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        Node newN = new Node(); //creating the node to add
        newN.data = x;//giving the node some data

        Node oldN = this.lastLeft.next;
        oldN.previous = newN;
        newN.next = oldN;
        newN.previous = this.lastLeft;
        this.lastLeft.next = newN;
    ...
    public final T removeRightFront() {
        ...
        Node oldRF = this.lastLeft.next;
        T returnData = oldRF.data;//getting the old right front node and data

        Node newRF = oldRF.next; //getting the new front

        newRF.previous = this.lastLeft;//making sure to fix the prvious of the new node
        this.lastLeft.next = newRF;//making sure to fix the next of the new node
    ...
    public final void moveToStart() {
        ...
        this.lastLeft = this.preStart;//sets the front to the start smart node
